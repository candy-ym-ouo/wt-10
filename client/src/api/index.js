...
export const moduleApi = {
  ...
  getModulePatchRecommendations: (id, params) => api.get(`/modules/${id}/patch-recommendations`, { params }),
...
export const socialApi = {
  ...
  getMyTrash: (params) => api.get('/me/trash', { params }),
...
export const adminApi = {
  ...
  updatePatchStatus: (id, status, reviewNote) => api.put(`/admin/patches/${id}/status`, { status, review_note: reviewNote }),
  togglePatchPublic: (id, is_public) => api.put(`/admin/patches/${id}/public`, { is_public }),
  deletePatch: (id) => api.delete(`/admin/patches/${id}`),
  restorePatch: (id) => api.post(`/admin/patches/${id}/restore`),
  getTrashPatches: (params) => api.get('/admin/patches/trash', { params }),
  permanentDeletePatch: (id) => api.delete(`/admin/patches/${id}/permanent`),
  ...
  recalculateAffinity: () => api.post('/admin/modules/combinations/recalculate-affinity'),
