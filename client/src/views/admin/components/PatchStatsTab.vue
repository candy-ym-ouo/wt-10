<template>
  <div class="stats-tab">
    <div class="filter-bar">
      ...
      <el-select v-model="statusFilter" placeholder="状态筛选" class="filter-select" @change="handleSearch">
      ...
      <el-select v-model="sortBy" placeholder="排序方式" class="filter-select" @change="handleSearch">
        <el-option label="浏览量" value="views_count" />
        <el-option label="点赞数" value="likes_count" />
        <el-option label="收藏数" value="favorites_count" />
